...
- [x] Descrição geral do projeto, incluindo a utilidade prática. 
- [x] Indicação do tipo de estudo: experimento laboratorial, estudo 
observacional, ensaio clínico, etc. 
- [x] Finalidade da entrevista: planejamento amostral, elaboração de 
questionário, crítica de análises realizadas, sugestão para análise, etc.
...
logístico multinível e auxílio na pós-estimação do modelo e na interpretação dos
coeficientes.


# Descrição do estudo

- [ ] Tipo de planejamento/amostragem (__número de fatores__, níveis, presença de dados incompletos, etc.). 
- [x] Identificação e número de unidades amostrais. 
...
- [x] Denominação e classificação das variáveis. 
- [ ] Codificação. (precisa?)
- [x] Tipo de questionários ou formulários. 
- [x] Forma de armazenagem de dados. 
- [x] Recursos computacionais disponíveis. 
...
- [x] Fase atual de implementação. 
- [x] Descrição e críticas às análises já realizadas. 
...
Outro problema relacionado a análise realizada é a forma como as saídas do Stata
