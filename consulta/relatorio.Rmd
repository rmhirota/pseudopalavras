...
Nota-se que os interceptos variam de distrito para distrito (considera-se que possa existir diferenças entre eles), e que agora a inclinação referente a variável 
