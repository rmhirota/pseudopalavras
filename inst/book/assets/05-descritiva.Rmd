...
proparoxítonas de três sílabas na estrutura proposta 
(CV-CV-CV ou CV-CV-CVC, C = consoante e V = vogal). 
...
Além disso, nota-se também que palavras-alvo oxítonas e paroxítonas geram
pseudopalavras cuja classificação se distribui de forma razoavelmente uniforme entre 
oxítonas e paroxítonas, o que não ocorre com as palavras-alvo proparoxítonas. 

Logo, pode-se pensar que pseudopalavras derivadas de proparoxítonas não tendem 
a ser acentuadas com a mesma tonicidade da palavra alvo (11,4%), enquanto
pseudopalavras lidas como proparoxítonas tendem a ser derivadas de 
proparoxítonas (73%).
