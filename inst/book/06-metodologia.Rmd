...
```{r parametros-grupo}
mf <- readr::read_rds("~/CEA - 2021/TCC/pseudopalavras/data-raw/m_mf_grupo_val.rds")
...
```{r parametros-sim-freq}
mf2 = readr::read_rds("~/CEA - 2021/TCC/pseudopalavras/data-raw/m_val_sim_mf2.rds")
