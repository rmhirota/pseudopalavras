...
Além disso, verifica-se que a proporção de proparoxítonas é inferior às outras categorias 
...
nota-se que quando a palavra alvo é do tipo proparoxítona, os participantes tendem a marcar a antepenúltima sílaba da pseudopalavra como sílaba tônica (proparoxítona). 
Em números, temos que 73% das pseudopalavras cuja palavra alvo era uma proparoxítona foram acentuadas dessa maneira
