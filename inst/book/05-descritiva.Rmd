...
Como temos dados no formato de medidas repetidas (falantes acentuando diversas pseudopalavras) e uma mesma palavra-alvo gerou diversas pseupalavras, o pressuposto de independência entre as observações não é verdadeiro. 

Logo, pensou-se em aplicar um teste de concordância do tipo Kappa para entender se os falantes aplicam a acentuação tônica nas pseudopalavras de forma distinta. Assim, será possível definir posteriormente se um modelo do tipo aleatório para os falantes é necessário.

Observando a estatística Kappa geral (0.54) temos que existe concordância entre as respostas dos falantes. Porém, apesar das categorias oxítona e pararoxítona possuírem estatísticas Kappa altas(0.61 e 0.54), a categoria proparoxítona possui um baixo grau de concordância entre os falantes (0.14).
