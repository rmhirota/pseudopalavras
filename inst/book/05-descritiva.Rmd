...
pseudopalavras::dados %>%
  ...
  knitr::kable(
    ...
    booktabs = TRUE,
    table.attr = "style='width:100%;'",
    caption = "Frequência da tonicidade da produção por nível de tonicidade 
das palavras-alvo."
  ) %>% 
  kableExtra::kable_styling(full_width = TRUE) %>% 
...
pseudopalavras::dados %>% 
  ...
  knitr::kable(
    ...
    booktabs = TRUE,
    table.attr = "style='width:100%;'",
    caption = "Frequência da Tonicidade da produção por Estrutura das palavras."
  ) %>% 
  kableExtra::add_header_above(
...
pseudopalavras::dados %>% 
  ...
  knitr::kable(
    ...
    booktabs = TRUE,
    table.attr = "style='width:100%;'",
    caption = "Frequência da tonicidade das produção, por nível da variável Validação."
  ) %>% 
  kableExtra::kable_styling(full_width = TRUE) %>% 
  kableExtra::add_header_above(
