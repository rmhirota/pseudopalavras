...
pseudopalavras::dados %>% 
  ...
  dplyr::transmute(
    ...
    paroxitona = glue::glue("{paroxitona} ({scales::percent(paroxitona/total)})"),
    proparoxitona = glue::glue("{proparoxitona} ({scales::percent(proparoxitona/total)})"),
...
pseudopalavras::dados %>% 
  ...
  knitr::kable(
    ...
    caption = "Frequência do Grupo experimental por Tonicidade da pseudopalavra.",
    booktabs = TRUE,
    table.attr = "style='width:100%;'"
  ) %>% 
  kableExtra::add_header_above(
