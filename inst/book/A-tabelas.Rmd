...
purrr::map_dfr(1:4, teste_grupo)%>%select(grupo,coeff)%>%
...
purrr::map_dfr(unique(pseudopalavras::dados$estrutura_palavra), teste_estrutura)%>%select(estrutura,coeff)%>%
...
purrr::map_dfr(unique(pseudopalavras::dados$segmento_modificado), teste_segmento)%>%select(segmento_modificado,coeff)%>%
