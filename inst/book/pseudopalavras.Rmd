...
tais palavras criadas. A seguir, as respostas dos participantes foram classificadas de acordo com as três classes de acentuação tônica: oxítona, paroxítona e proparoxítona.
...
seguir, enquanto o outro será mencionado na seção \@ref(descricao-variaveis)
...
e valores maiores ou iguais a 5 determinam palavras dissimilares. Logo, foi necessário 
definir um modo de validar essa classificação em similar e dissimilar. 
...
não associadas a uma mesma resposta por mais de dois indivíduos. Em outras palavras, se mais
de dois falantes lembraram de uma mesma palavra ao ler a pseudopalavra, ela foi considerada
dissimilar à sua palavra-alvo - pois entendeu-se que ela está "parecida" com uma palavra real.
Pseudopalavras nas quais três falantes apresentaram a mesma associação foram classificadas como
quase validadas. Ressalta-se que, nesse caso, a associação não necessariamente precisava ser 
com a palavra-alvo.
